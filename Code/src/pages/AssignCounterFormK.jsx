...
function AssignCounterForm({ departments, onSubmit, onCancel }) {
  ...
  const validateForm = () => {
    ...
    if (!formData.counter) newErrors.counter = 'Counter is required';
    ...
    if (!formData.password || formData.password.length <= 6) newErrors.password = 'Password must be longer than 6 characters';
