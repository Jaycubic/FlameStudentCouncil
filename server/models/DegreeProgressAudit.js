// server/models/DegreeProgressAudit.js
const { DataTypes } = require('sequelize');
const sequelize = require('../config/cgpa');

const DegreeProgressAudit = sequelize.define('degreeprogressaudit', {
  id: {
...
module.exports = DegreeProgressAudit;